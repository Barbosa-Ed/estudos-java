...
public class Janela extends JFrame implements ActionListener {
    ...
    private ImageIcon imgDino1;
    private ImageIcon imgDino2;
    private ImageIcon imgDino3;
    ...
    public Janela() {
        ...
        pista = new ImageIcon("./src/imagens/pista.jpg");
        ...
        imgDino1 = new ImageIcon("./src/imagens/dino1.png");
        imgDino2 = new ImageIcon("./src/imagens/dino2.png");
        imgDino3 = new ImageIcon("./src/imagens/dino3.png");
     ...
     public JLabel JLabelDinos(String nome, ImageIcon img, int posX, int posY) {
        DinoThread dino = new DinoThread(nome, img, posX, posY);
        dino.setSize(256, 141);
    ...
    public void actionPerformed(ActionEvent dispara) {
        if (dispara.getSource() == this.btnCorrida) {
            this.lblPista.add(JLabelDinos("Dino1", imgDino1, 0, 50));
            this.lblPista.add(JLabelDinos("Dino2", imgDino2, 0, 200));
            this.lblPista.add(JLabelDinos("Dino3", imgDino3, 0, 350));
        }
